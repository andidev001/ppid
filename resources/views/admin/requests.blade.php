    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div
            ...
            <div>
                ...
                <p class="text-[13px] text-slate-500 mt-1 ml-9">Verifikasi dan tindak lanjuti permintaan informasi
                    publik secara rinci.</p>
            </div>
        </div>
            ...
            <table class="w-full text-left border-collapse" id="requestsTable">
                <thead>
                    <tr
                        ...
                        <th class="px-5 py-3">Subjek Permohonan</th>
        ...
        function initializeRequestsTable() {
            ...
            $('#requestsTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'subject_info', name: 'subject' },
                    { data: 'attachment', name: 'attachment_path', orderable: false, searchable: false, className: 'text-center' },
                ...
                pageLength: 10,
                order: [[3, 'asc']] // Sort status as default if possible, or leave default
            });
