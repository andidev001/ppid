                        ...
                        api.column(0, { page: 'current' }).data().each(function (group, i) {
                            if (last !== group) {
                                if (group) {
                                    ...
                                    @endif
                                    $(rows).eq(i).before(
                                        '<tr class="group-header"><td colspan="' + colspan + '" class="text-white font-bold p-4 text-sm sm:text-base tracking-wide" style="background-color: #172554; border-left: 6px solid #f59e0b; color: white;">' + group + '</td></tr>'
                                    );
                                }
                                last = group;
                                rowNum = 1;
