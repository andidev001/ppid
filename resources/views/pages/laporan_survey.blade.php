...
@section('content')
    <div class="bg-slate-900 pb-32 pt-16 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-2xl md:text-4xl font-extrabold text-white brand-font tracking-tight mb-4">Laporan Hasil Survey
            </h1>
        ...
        @else
            <div
                ...
                <p class="text-slate-500 max-w-lg mx-auto leading-relaxed mb-8">
                    Saat ini belum ada dokumen yang diunggah untuk kategori Laporan Hasil Survey.
                </p>
                <a href="{{ url('/') }}"
